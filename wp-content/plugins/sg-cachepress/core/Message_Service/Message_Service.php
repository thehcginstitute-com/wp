...
class Message_Service {
	...
	public static function get_response_message( $result, $option, $type = null ) {
		...
		$messages = array(
			...
			'lazyload_gravatars'             => __( 'Lazy Loading Gravatars', 'sg-cachepress' ),
			'lazyload_thumbnails'            => __( 'Lazy Loading Thumbnails', 'sg-cachepress' ),
			'lazyload_responsive'            => __( 'Lazy Loading Responsive Images', 'sg-cachepress' ),
			'lazyload_textwidgets'           => __( 'Lazy Loading Widgets', 'sg-cachepress' ),
			'lazyload_mobile'                => __( 'Lazy Load for Mobile', 'sg-cachepress' ),
			'lazyload_woocommerce'           => __( 'Lazy Load for Product Images', 'sg-cachepress' ),
			'lazyload_shortcodes'            => __( 'Fix for Lazy Loading Short Codes', 'sg-cachepress' ),
			'lazyload_videos'                => __( 'Lazy Load Videos', 'sg-cachepress' ),
			'lazyload_iframes'               => __( 'Lazy Load Iframes', 'sg-cachepress' ),
