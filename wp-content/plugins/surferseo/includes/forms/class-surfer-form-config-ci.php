...
class Surfer_Form_Config_Ci extends Surfer_Form {
	...
	private function render_content_import_defaults_section() {
		...
		if ( surfer_check_if_plugins_is_active( 'elementor/elementor.php' ) ) {
			$field->add_option( 'elementor_canvas', __( 'Elementor Canvas', 'surferseo' ) );
			$field->add_option( 'elementor_header_footer', __( 'Elementor Full Width', 'surferseo' ) );
			$field->add_option( 'elementor_theme', __( 'Theme', 'surferseo' ) );
		}
