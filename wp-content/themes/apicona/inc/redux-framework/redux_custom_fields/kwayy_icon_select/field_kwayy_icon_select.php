...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxFramework_kwayy_icon_select' ) ) {
        class ReduxFramework_kwayy_icon_select {
            ...
            function render() {
				...
				echo '<select id="' . $this->field['id'] . '-select" name="' . $this->field['name'] . '' . $this->field['name_suffix'] . '" class="redux-kwayy_icon_select-item ' . $this->field['class'] . '" style="width:430px;" rows="6">';
                    echo '<option></option>';
                ...
                if ( ! empty( $this->field['options'] ) ) {
                    ...
                    echo '<select ' . $multi . ' id="' . $this->field['id'] . '-select" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . '' . $nameBrackets . $this->field['name_suffix'] . '" class="redux-kwayy_icon_select-item ' . $this->field['class'] . $sortable . '"' . $width . ' rows="6">';
                    echo '<option></option>';
            ...
            function enqueue() {
				...
				wp_enqueue_script(
                    'field-kwayy_icon_select-js',
                    //ReduxFramework::$_url . 'inc/fields/kwayy_icon_select/field_kwayy_icon_select.js',
					get_template_directory_uri() . '/inc/redux-framework/redux_custom_fields/kwayy_icon_select/field_kwayy_icon_select.js',
                ...
                /*wp_enqueue_style(
                    'redux-field-kwayy_icon_select-css',
                    ReduxFramework::$_url . 'inc/fields/kwayy_icon_select/field_select.css',
                    time(),
                    true
                );*/
            } //function
