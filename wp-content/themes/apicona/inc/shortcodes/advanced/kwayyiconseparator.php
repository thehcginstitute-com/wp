...
if( !function_exists('thememount_sc_kwayyiconseparator') ){
function thememount_sc_kwayyiconseparator( $atts, $content=NULL ){
...
add_shortcode( 'kwayyiconseparator', 'thememount_sc_kwayyiconseparator' );