...
$customDiv 		  = '';
if($bgimage==true || $css!='' || $colorbg==true || !empty($parallax_image) || !empty($video_bg_url) ){
	$thememountClass .= ' tm-col-main';
	$customDiv 		  = '<div class="tm-col-overlay"></div>';
}

if( $bgimage==true || !empty($parallax_image) || !empty($video_bg_url) ){
...
// Custom Class
$css_classes[] = esc_attr( trim( vc_shortcode_custom_css_class( $css ) ) ); // Added by ThemeMount
...
if(trim($css)!= ''){
	...
	$thememount_inline_css  .= '.'.$new_bgimage_element.'{background-image: none !important;}';
