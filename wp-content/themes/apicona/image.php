			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
				...
				<header class="entry-header">
					...
					<div class="entry-meta">
						<?php
							$published_text = __( '<span class="attachment-meta">Published on <time class="entry-date" datetime="%1$s">%2$s</time> in <a href="%3$s" title="Return to %4$s" rel="gallery">%5$s</a></span>', 'apicona' );
							...
							printf( '<span class="attachment-meta full-size-link"><a href="%1$s" title="%2$s">%3$s (%4$s &times; %5$s)</a></span>',
								...
								esc_attr__( 'Link to full-size image', 'apicona' ),
								__( 'Full resolution', 'apicona' ),
								$metadata['width'],
								$metadata['height']
							);
				...
				<div class="entry-content">
					<nav id="image-navigation" class="navigation image-navigation" role="navigation">
						<span class="nav-previous"><?php previous_image_link( false, '<span class="meta-nav">&larr;</span> ' . esc_html__( 'Previous', 'apicona' ) ); ?></span>
						<span class="nav-next"><?php next_image_link( false, esc_html__( 'Next', 'apicona' ) . ' <span class="meta-nav">&rarr;</span>' ); ?></span>
					</nav><!-- #image-navigation -->

					<div class="entry-attachment">
						<div class="attachment">
							<?php apicona_the_attached_image(); ?>
