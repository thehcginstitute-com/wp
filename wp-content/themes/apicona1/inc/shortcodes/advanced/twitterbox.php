...
function kwayy_sc_twitterbox( $atts, $content=NULL ){
	...
	$tweetList = kwayy_twitterbar($keys, $followustext);
...
/******************** Extra Functions *********************/
function kwayy_twitterbar($keys, $followustext) {
	...
	if( $followustext!='' ){
		$followustext = '<br><span class="tm-sc-twitterbox-followus-text"><small>'.$followustext.'</small></span>';
	}
		...
		$return .= '
			<section class="kwayy-twitterbar-wrapper kwayy-items-wrapper kwayy-effect-carousel kwayy-carousel-col-one kwayy-with-pagination" data-autoplayspeed="800" data-autoplay="1" data-loop="1" data-autoplaytimeout="4500">
				<div class="kwayy-twitterbar">
					<h3><span>Twitter link</span><a class="twitter-link" href="http://twitter.com/' . $username . '"><i class="kwicon-fa-twitter"></i>'.$followustext.'</a></h3>
